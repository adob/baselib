module;
#include "chan_lockreduced_impl+experimental.h"

export module lib.sync.chan_lockreduced;
import <boost/circular_buffer.hpp>;
import "deps/atomic_queue/include/atomic_queue/atomic_queue.h";
import <atomic>;
import <pthread.h>;
...
namespace lib::sync {
    ...
    namespace internal {
        ...
        struct LinkedList {
            atomic<Selector*> head = nil;
            atomic<Selector*> tail = nil;

            Selector *peek() {
                Selector *e = head.load();
            again:
                if (e == nil) {
                    return e;
                }

                if (!head.compare_and_swap(&e, SelectorBusy)) {
                    goto again;
                }
        ...
        protected:
            ...
            bool send_nonblocking_buffered(this ChanBase &c, void *elem, bool move, Data *data_out);
            bool send_nonblocking_unbuffered(this ChanBase &c, void *elem, bool move, Data *data_out);
            
            int send_sel(this ChanBase &c, Selector *receiver);
            int send_sel_buffered(this ChanBase &c, Selector *receiver);
            int send_sel_unbuffered(this ChanBase &c, Selector *receiver);
            ...
            bool recv_nonblocking_buffered(this ChanBase &c, void *out, bool *ok, Data *data_out);
            bool recv_nonblocking_unbuffered(this ChanBase &c, void *out, bool *ok, Data *data_out);

            int recv_sel(this ChanBase &c, Selector *receiver);
            int recv_sel_buffered(this ChanBase &c, Selector *receiver);
            int recv_sel_unbuffered(this ChanBase &c, Selector *receiver);
